...
// image url imports
import atlasURL from '../textures/sam_atlas.png';
...
reg.registerMaterial('stone-side', {textureURL: atlasURL, atlasIndex: 4});
reg.registerMaterial('sky', {textureURL: atlasURL, atlasIndex: 5});
reg.registerMaterial('cake-top', {textureURL: atlasURL, atlasIndex: 6});
reg.registerMaterial('cake-side', {textureURL: atlasURL, atlasIndex: 7});
reg.registerMaterial('cake', {textureURL: atlasURL, atlasIndex: 8});
reg.registerMaterial('dirt2', {textureURL: atlasURL, atlasIndex: 9});
reg.registerMaterial('grass2', {textureURL: atlasURL, atlasIndex: 10});
reg.registerMaterial('dirt3', {textureURL: atlasURL, atlasIndex: 10});

blockIDs.dirt = reg.registerBlock(_id++, {material: 'dirt'});
blockIDs.grass = reg.registerBlock(_id++, {
  material: ['grass', 'dirt', 'gside'],
});
blockIDs.dirt2 = reg.registerBlock(_id++, {
  material: 'dirt2',
});
blockIDs.dirt3 = reg.registerBlock(_id++, {
  material: 'dirt3',
});
blockIDs.topCake = reg.registerBlock(_id++, {
  material: ['cake-top', 'cake', 'cake-side'],
});
blockIDs.cake = reg.registerBlock(_id++, {
  material: 'cake',
});
blockIDs.stone = reg.registerBlock(_id++, {material: 'stone'});
...
reg.registerMaterial('stonea', {
  textureURL: transparentAtlas,
  texHasAlpha,
  atlasIndex: 0,
});
reg.registerMaterial('stonec', {
  textureURL: transparentAtlas,
  texHasAlpha,
  atlasIndex: 2,
});
reg.registerMaterial('stonee', {
  textureURL: transparentAtlas,
  texHasAlpha,
  atlasIndex: 4,
});
...
blockIDs.custom1 = reg.registerBlock(_id++, {
  blockMesh: make(transparent1),
  opaque: false,
});
blockIDs.custom2 = reg.registerBlock(_id++, {
  blockMesh: make(transparent2),
  opaque: false,
});
